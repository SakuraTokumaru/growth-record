...
ブランチ、クローン、プル、プッシュ、マージ...等々の基本ワードの意味と使い方を理解する必要あり。GitHub、VScodeそれぞれのやり方を学ぶ必要あり。下記に意味や仕方を記載しておく予定。  
...
2.JavaScriptで表示を切り替える　セレクトボックスで言語を切り替えたいとき、<chengeイベント>を実装し表示の切り替えを行う。  
